<div class="arch arch-5" style="background-image:url(<?php echo(get_stylesheet_directory_uri()); ?>/img/arch-5.svg);"></div>
<div class="sans-cont sans-grd-cont arch-footer-content">
            ...
            <div class="arch" style="background-image:url(<?php echo(get_stylesheet_directory_uri()); ?>/img/arch-2.svg);"></div>
